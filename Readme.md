# HW20. Node Basic Modules

**Task1. Створіть власний модуль та імпортуйте його**
...
**Task2.1. Практика з вбудованим модулем fs**
...
**Task2.2. Робота з директоріями через fs**
...
**Task3. Використання модуля path**
...
**Task4. Отримання інформації про систему за допомогою os**
...
**Task5. Створення простого HTTP-сервера**
...
**Task6. Робота з подіями через events**
...
**Task7. Хешування даних через crypto**
...
**Task8. Розбір URL за допомогою url**
